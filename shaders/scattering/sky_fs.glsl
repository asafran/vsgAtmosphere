...
layout(set = 1, binding = 2) uniform sampler2D s_Transmittance;
layout(set = 1, binding = 3) uniform sampler2D s_Irradiance;
layout(set = 1, binding = 4) uniform sampler3D s_Scattering;
layout(set = 1, binding = 5) uniform sampler3D s_SingleMieScattering;

layout(set = 2, binding = 0) uniform sampler3D s_ShapeNoise;
layout(set = 2, binding = 1) uniform sampler3D s_DetailNoise;
layout(set = 2, binding = 2) uniform sampler2D s_BlueNoise;
layout(set = 2, binding = 3) uniform sampler2D s_CurlNoise;

const int NUM_CONE_SAMPLES = 6;

layout(set = 2, binding = 4, std140) uniform Clouds
{
